...
<template>
  <div class="flex flex-col px-16 py-3 justify-center gap-y-1 w-fit items-center bg-white rounded-lg text-gray-800 shadow">
    <p class="text-sm text-gray-500">Score</p>
    <div class="flex justify-center items-center gap-x-2 font-bold text-3xl">
